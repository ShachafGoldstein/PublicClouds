...
automationConnection = automationassets.get_automation_connection("AzureRunAsConnection")
...
pks12_cert = crypto.load_pkcs12(automationassets.get_automation_certificate("AzureRunAsCertificate"))
...
credentials = AdalAuthentication(
    lambda: context.acquire_token_with_client_certificate(
            ...
            automationConnection["ApplicationId"],
            pem_pkey,
            thumbprint)
)
